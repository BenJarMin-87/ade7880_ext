...
// Registers for ADE7880 (extended version)
...
// HCONFIG bit fields we need
constexpr uint16_t HCONFIG_ACTPHSEL_MASK = (0x3u << 8);
constexpr uint16_t HCONFIG_HPHASE_MASK = (0x3u << 1);
constexpr uint16_t HCONFIG_ACTPHSEL_SHIFT = 8;
constexpr uint16_t HCONFIG_HPHASE_SHIFT = 1;
